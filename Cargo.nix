...
rec {
  ...
  workspaceMembers = {
    "valence-coprocessor-domain-prover" = rec {
      packageId = "valence-coprocessor-domain-prover";
    ...
    "valence-coprocessor-domain-prover-builder" = rec {
      packageId = "valence-coprocessor-domain-prover-builder";
      build = internal.buildRustCrateWithFeatures {
        packageId = "valence-coprocessor-domain-prover-builder";
      };
    ...
    "valence-coprocessor-domain-prover-circuit" = rec {
      packageId = "valence-coprocessor-domain-prover-circuit";
      build = internal.buildRustCrateWithFeatures {
        packageId = "valence-coprocessor-domain-prover-circuit";
      };
    ...
    "valence-coprocessor-domain-prover-controller" = rec {
      packageId = "valence-coprocessor-domain-prover-controller";
      build = internal.buildRustCrateWithFeatures {
        packageId = "valence-coprocessor-domain-prover-controller";
      };
    ...
    "valence-coprocessor-domain-prover-service" = rec {
      packageId = "valence-coprocessor-domain-prover-service";
      build = internal.buildRustCrateWithFeatures {
        packageId = "valence-coprocessor-domain-prover-service";
      };
    ...
    "valence-coprocessor-domain-prover-wrapper" = rec {
      packageId = "valence-coprocessor-domain-prover-wrapper";
      build = internal.buildRustCrateWithFeatures {
        packageId = "valence-coprocessor-domain-prover-wrapper";
      };
...
";
      ...
      "camino" = rec {
        ...
        sha256 = "00w66vqc302fa2pch4m9qkv495cv78p1a35zng78b4wymb08ppp1";
        authors = [
...
";
      ...
      "const-hex" = rec {
        ...
        sha256 = "19pdf77asqh7gaczjywq1igl0ijx9sbiq76wlc7px8yyfkzpnh5n";
        libName = "const_hex";
        authors = [
...
";
      ...
      "ctrlc" = rec {
        ...
        sha256 = "1wy41p6lskx853xph4sb5lahwfbqvax2rs064f74kwdj2c55s748";
        authors = [
...
";
        sha256 = "0c7sygw9dlczgjkk6kvp2sxrz81zc51rgrycah69kp8n1csgxk86";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
        ];
        dependencies = [
...
";
      ...
      "msgpacker-derive" = rec {
        ...
        sha256 = "0gw5z4rjy8vnk06alr537a984h5g0c7rq5215rf9rwnllrvsnd63";
        procMacro = true;
...
";
      ...
      "ruint" = rec {
        ...
        sha256 = "0y6jj7xb3gb533z6wwjh2gi4lld76qm2jksk977217aw1qwg13d6";
        authors = [
...
";
      ...
      "sp1-lib" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "ecdsa" "verify" ];
      };
      "sp1-primitives" = rec {
      ...
      "sp1-zkvm" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "lib" "libm" "verify" ];
      };
      "spin" = rec {
        crateName = "spin";
        version = "0.9.8";
...
";
      ...
      "valence-coprocessor" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "valence-coprocessor-types";
          }
          {
            name = "zerocopy";
            packageId = "zerocopy";
      ...
      "valence-coprocessor-domain-prover" = rec {
        ...
        libName = "valence_coprocessor_domain_prover";
        authors = [
          "Timewave Labs"
        ];
        dependencies = [
      ...
      "valence-coprocessor-domain-prover-builder" = rec {
        ...
        crateBin = [
          {
            name = "valence-coprocessor-domain-prover-builder";
            path = "src/main.rs";
            requiredFeatures = [ ];
          }
        ];
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/builder; };
        authors = [
          "Timewave Labs"
        ];
        dependencies = [
        ...
        buildDependencies = [
          ...
          {
            name = "valence-coprocessor-domain-prover";
            packageId = "valence-coprocessor-domain-prover";
          }
          {
            name = "zerocopy";
      ...
      "valence-coprocessor-domain-prover-circuit" = rec {
        crateName = "valence-coprocessor-domain-prover-circuit";
        version = "0.1.0";
        edition = "2021";
        crateBin = [
          {
            name = "valence-coprocessor-domain-prover-circuit";
            path = "src/main.rs";
            requiredFeatures = [ ];
          }
        ];
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/circuit; };
        dependencies = [
          {
            name = "msgpacker";
            packageId = "msgpacker";
      ...
      "valence-coprocessor-domain-prover-controller" = rec {
        ...
        libName = "valence_coprocessor_domain_prover_controller";type = [ "cdylib" ];
        authors = [
          "Timewave Labs"
        ];
        dependencies = [
        ...
        features = {
          "wasm" = [ "valence-coprocessor-wasm/abi-handlers" ];
        };
      ...
      "valence-coprocessor-domain-prover-service" = rec {
        ...
        crateBin = [
          {
            name = "valence-coprocessor-domain-prover-service";
            path = "src/main.rs";
            requiredFeatures = [ ];
          }
        ];
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/service; };
        libName = "valence_coprocessor_domain_prover_service";
        authors = [
          "Timewave Labs"
        ];
        dependencies = [
      ...
      "valence-coprocessor-domain-prover-wrapper" = rec {
        crateName = "valence-coprocessor-domain-prover-wrapper";
        version = "0.1.0";
        edition = "2021";
        crateBin = [
          {
            name = "valence-coprocessor-domain-prover-wrapper";
            path = "src/main.rs";
            requiredFeatures = [ ];
          }
        ];
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/wrapper; };
        dependencies = [
          {
            name = "msgpacker";
            packageId = "msgpacker";
      ...
      "valence-coprocessor-types" = rec {
        ...
        resolvedDefaultFeatures = [ "blake3" "default" ];
      };
      "valence-coprocessor-wasm" = rec {
        ...
        resolvedDefaultFeatures = [ "abi-handlers" "dlmalloc" ];
      };
      "valuable" = rec {
        crateName = "valuable";
        version = "0.1.1";
...
";
      ...
      "wildmatch" = rec {
        ...
        sha256 = "10nk5s864iczsdrxn38iypixp5mk36pwyv2k0xkfzfka4dxd1drr";
        authors = [
      ...
      "windows-sys 0.59.0" = rec {
        ...
        resolvedDefaultFeatures = [ "Wdk" "Wdk_Foundation" "Wdk_Storage" "Wdk_Storage_FileSystem" "Wdk_System" "Wdk_System_IO" "Win32" "Win32_Foundation" "Win32_Networking" "Win32_Networking_WinSock" "Win32_Security" "Win32_Storage" "Win32_Storage_FileSystem" "Win32_System" "Win32_System_Console" "Win32_System_IO" "Win32_System_Pipes" "Win32_System_SystemServices" "Win32_System_Threading" "Win32_System_WindowsProgramming" "Win32_UI" "Win32_UI_Input" "Win32_UI_Input_KeyboardAndMouse" "default" ];
      };
      "windows-sys 0.60.2" = rec {
        ...
        resolvedDefaultFeatures = [ "Win32" "Win32_Foundation" "Win32_Networking" "Win32_Networking_WinSock" "Win32_System" "Win32_System_Console" "Win32_System_IO" "Win32_System_Memory" "Win32_System_SystemInformation" "Win32_System_Threading" "default" ];
      };
